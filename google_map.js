...
//"https://maps.googleapis.com/maps/api/js?key="+encodeURIComponent(Google_API_Key)+"&callback=initMap&libraries=places";
const uri = "https://maps.googleapis.com/maps/api/js?key="+atob(Google_API_Key)+"&callback=initMap&libraries=places";
const encoded_uri = encodeURI(uri);
script.src = encoded_uri;
script.async = true;
